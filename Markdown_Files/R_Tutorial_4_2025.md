BOPRC R Tutorial 4 - Manipulating and plotting time series data: Part 2
(high frequency data)
================
...
***Challenge 1:*** *Use the ‘summary’ funtion to inspect Discharge_DF.
...
![](R_Tutorial_4_2025_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
![](R_Tutorial_4_2025_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](R_Tutorial_4_2025_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](R_Tutorial_4_2025_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
![](R_Tutorial_4_2025_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
```
    ...
    ##  $ Day_Stamp: Date[1:41], format: "2023-01-20" "2023-01-21" ...
    ##  $ Value    : num [1:41] 4.51 4.45 4.4 4.35 4.31 ...
...
Fantastic! We can see how nitrate at this site starts with an elevated
baseline of around 1.62 mg/l and then becomes diluted when storm events
come through. This suggests that nitrate is supplied through baseflow
(groundwater inputs) and high levels of rainfall cause a dilution
effect. This type of stream signature is common in the Bay of Plenty,
particularly in the Taupo Volcanic Zone where porous volcanic soils
result in vertical leaching of nitrate (which is water soluble) to
underlying aquifers.
...
![](R_Tutorial_4_2025_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
